import { Alert, Platform, Pressable, SafeAreaView, StatusBar, StyleSheet, Text, View, Image, TextInput, ScrollView } from 'react-native'
...
const HomeScreen = () => {
  ...
  const checkIfLocationEnabled = async () => {
    ...
    if (!enabled) {
      Alert.alert('Location service are not enabled', 'Please enable the location services', [
        {
          text: 'Cancel',
      ...
      <ScrollView style={styles.AndroidSafeArea}>
        <View style={{ flexDirection: "row", alignItems: "center", padding: 10 }}>
          ...
          <Pressable onPress={() => navigation.navigate("Profile")} style={{ marginLeft: "auto", marginRight: 7 }}>
            <Image source={{ uri: "https://lh3.googleusercontent.com/ogw/ANLem4aXZjpkS9-2MuYnJvHeQKqmgSE_Q-ur0TkIgPcPxw=s32-c-mo" }} style={{ width: 40, height: 40, borderRadius: 20 }} />
          </Pressable>
        </View>
